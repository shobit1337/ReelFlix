...
export const categories = [
  {
    _id: '046ebe49-6ae6-417f-a4ec-ca20d372b5fb',
  ...
  {
    _id: 'c6a3f89d-9352-42f8-bded-99f43064c8bb',
  ...
  {
    _id: '2a040eac-14cd-4693-95ba-15750ce1fbce',
    categoryName: 'Romance',
    description:
      'Romance films are love stories, or affairs of the heart that center on passion, emotion, and the romantic, affectionate involvement of the main characters (usually a leading man and lady), and the journey that their love takes through courtship or marriage.',
  },
];
